...
complete -c ort -n "__fish_seen_subcommand_from analyze" -l package-managers -s m -r -d 'The comma-separated package managers to enable, any of [Bower, Bundler, Cargo, Carthage, CocoaPods, Composer, Conan, GoDep, GoMod, Gradle, Maven, NPM, NuGet, PIP, Pipenv, PNPM, Poetry, Pub, SBT, SpdxDocumentFile, Stack, Unmanaged, Yarn, Yarn2]. Note that disabling overrides enabling. If set, the \'enabledPackageManagers\' property from configuration files is ignored.'
